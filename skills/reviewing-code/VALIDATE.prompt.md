...
grep -q "Five-Axis Review" skills/reviewing-code/SKILL.md && echo "✓ Five-axis review framework"
...
> Run the validation commands in `reviewing-code/VALIDATE.prompt.md` and report any issues found with the reviewing-code skill.
