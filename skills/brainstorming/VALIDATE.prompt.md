...
grep -q "No implementation skill" skills/brainstorming/SKILL.md && echo "✓ Critical rule: blocks implementation before approval"
...
grep -q "create a plan" skills/brainstorming/SKILL.md && echo "✓ Workflow step 5: creates implementation plan"
