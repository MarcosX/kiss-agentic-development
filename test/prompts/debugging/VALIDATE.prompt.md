...
grep -q "systematic debugging" skills/debugging/SKILL.md && echo "✓ Systematic debugging motivation"
grep -q "3-Fix Rule" skills/debugging/SKILL.md && echo "✓ 3-fix architectural rule present"
grep -q "spans multiple components" skills/debugging/SKILL.md && echo "✓ Multi-component tracing covered"
...
> Run the validation commands in `test/prompts/debugging/VALIDATE.prompt.md` and report any issues found with the debugging skill.
