...
grep -q "Create TODOs" skills/brainstorming/SKILL.md && echo "✓ TODO tracking instructed"
...
grep -q "Provide your recommended answer" skills/brainstorming/SKILL.md && echo "✓ Recommended answer pattern"
grep -q "Prefer multiple choice" skills/brainstorming/SKILL.md && echo "✓ Multiple choice preference"
...
grep -q "one question at a time" skills/brainstorming/SKILL.md && echo "✓ One question at a time rule"
