...
grep -q "acceptance criterion" skills/writing-plans/SKILL.md && echo "✓ AC coverage required"
grep -q "Done when" skills/writing-plans/SKILL.md && echo "✓ Done when section in template"
grep -q "DRY" skills/writing-plans/SKILL.md && echo "✓ DRY principle mentioned"
