...
```bash
test -f skills/executing-plans/reference/dispatch-agent.prompt.md && echo "✓ dispatch-agent.prompt.md exists"
test -f skills/executing-plans/reference/spec-review.prompt.md && echo "✓ spec-review.prompt.md exists"
test -f skills/executing-plans/reference/code-review.prompt.md && echo "✓ code-review.prompt.md exists"
```
...
> Run the validation commands in `test/prompts/executing-plans/VALIDATE.prompt.md` and report any issues found with the executing-plans skill.
